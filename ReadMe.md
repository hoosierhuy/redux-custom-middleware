An example of custom redux middleware for myself or anyone else to use as a reference, especially if you jump back and forth between stacks, tasks, frameworks, technologies, etc.  
